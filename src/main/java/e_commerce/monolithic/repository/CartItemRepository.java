...
public interface CartItemRepository extends JpaRepository<CartItem, Long> {
     ...
     * thông tin cần thiết (product variant, product, color, size) trong một câu
     * truy vấn duy nhất.
     */
    ...
    /**
     * Tìm một mục trong giỏ hàng dựa trên user_id, product_variant_id, và size_id.
     * Hữu ích để kiểm tra xem sản phẩm với size cụ thể đã có trong giỏ hàng chưa.
     */
    Optional<CartItem> findByUserIdAndProductVariantIdAndSizeId(Long userId, Long productVariantId, Long sizeId);
     ...
     * Điều này đảm bảo rằng người dùng chỉ có thể thao tác với các mục trong giỏ
     * hàng của chính họ.
     */
     ...
     * Sử dụng @Modifying và @Transactional vì đây là một câu lệnh DML (thay đổi dữ
     * liệu).
     * 
