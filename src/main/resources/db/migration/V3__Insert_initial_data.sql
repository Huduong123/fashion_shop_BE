...
-- -- MỚI: Chèn dữ liệu cho product_variants (các biến thể cụ thể)
...
-- Biến thể của Nón Bucket (id=3) - Nón có thể không có size, ta có thể tạo 1 size 'One Size'
(5, 3, 1, 2, 120000.00, 20, '/images/non-bucket-den.jpg');  -- Nón Bucket, Đen, M (giả sử M là size mặc định)


-- -- SỬA ĐỔI: Chèn dữ liệu cho cart_items (trỏ tới product_variant_id)
...
-- -- SỬA ĐỔI: Chèn dữ liệu cho orders và order_items (trỏ tới product_variant_id)
